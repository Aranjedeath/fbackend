...
api.add_resource(MediaPostAdd, '/post/media/add')
...
api.add_resource(PostView, '/post/view/<post_id>')
api.add_resource(PostViewShort, '/post/view/p/<client_id>')
...
api.add_resource(TimelineUserMultiType, '/timeline/user/<user_id>/multitype')
api.add_resource(TimelineCombined, '/timeline/home/multitype', '/timeline/homenew',)
api.add_resource(DiscoverPostMultiType, '/discover/post/multitype')
